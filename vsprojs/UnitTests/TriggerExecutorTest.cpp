...
namespace UT {
  namespace Classes {
    ...
    namespace TriggerExecutorImpl {
      ...
      typedef SelfTransition<Trigger::Timeout, OnState, StateTypeCreationPolicyType, NoGuard, NoAction, false> ToOnFromOnTransition;
      typedef SelfTransition<Trigger::Timeout, OffState, StateTypeCreationPolicyType, NoGuard, NoAction, false> ToOffFromOffTransition;
      ...
      typedef InitialTransition<OnState, StateTypeCreationPolicyType, NoAction> InitTransition;
    ...
    TEST_CLASS(TriggerExecutorTest)
    {
    public:
