...
namespace UT {
  namespace Classes {
    ...
    INIT(
      ...
      TEST(
        WrongActiveStateTriggerTimeout,
        Execute,
        UnhandledTransition)
      {
        using namespace EventDispatchersTestImpl;
