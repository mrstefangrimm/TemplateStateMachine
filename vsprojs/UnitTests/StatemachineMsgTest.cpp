...
namespace UT {
  namespace Classes {
    ...
    namespace StatemachineMsgTestImpl {
      ...
      typedef SelfTransition<Msg::Self, OnState, StateTypeCreationPolicyType, NoGuard, NoAction, false> ToOnFromOnSelfTransition;
      typedef SelfTransition<Msg::Self, OffState, StateTypeCreationPolicyType, NoGuard, NoAction, false> ToOffFromOffSelfTransition;
      typedef SelfTransition<Msg::Reenter, OnState, StateTypeCreationPolicyType, NoGuard, NoAction, true> ToOnFromOnReenterTransition;
      typedef SelfTransition<Msg::Reenter, OffState, StateTypeCreationPolicyType, NoGuard, NoAction, true> ToOffFromOffReenterTransition;
      typedef FinalTransition<OnState, StateTypeCreationPolicyType> ToFinalFromOnTransition;
